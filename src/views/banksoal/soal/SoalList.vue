            ...
            <div class="col-md-4">
              <div class="input-group input-group-sm mb-3">
                ...
                <select class="custom-select" v-model="tipe_soal">
                  ...
                  <option :value.int="8">Benar/salah</option>
                  <option :value.int="9">Setuju/tidak</option>
                </select>
              </div>
            </div>
          </div>
                  ...
                  <b-card style="border:1px dashed #00f;">
                    ...
                    <table class="table" v-if="row.item.jawabans != ''">
                      <tr v-for="(jawab, index) in row.item.jawabans" :key="index">
                        ...
                        <td width="20" v-if="[8].includes(row.item.tipe_soal)">
                          <span class="text-success" v-show="jawab.correct == '1'">&#9745;</span>
                          <span class="text-danger" v-show="jawab.correct == '0'">&#9746;</span>
                        </td>
